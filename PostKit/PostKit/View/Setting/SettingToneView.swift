...
struct SettingToneView: View {
    ...
    var tons: [String] = ["기본","친구같은","전문적인","친절한","재치있는","열정적인","감성적인","활발한","세련된","우왕","개쩐다"]
    var body: some View {
        toggleBtns
    }
}
...
extension SettingToneView {
    private var toggleBtns: some View {
        VStack(alignment:.leading) {
            ...
            ForEach(0..<tons.count / 2 + 1, id: \.self) { rowIndex in
                HStack {
                        ...
                        if item < tons.count {
                            Button {
                                ...
                                RoundedRectangle(cornerRadius: 16)
                                    ...
                                    .foregroundStyle(tons[item] == tone ? Color.pink.opacity(0.7): Color.gray.opacity(0.4))
